...
import ctal from '../assets/cta1.webp'
...
function CtaOne() {
  ...
  return (
    <div id='ctal' style={{backgroundImage: `url({${cta1})`}} className='relative w-full lg:h-125 h-auto lg:p-22 p-10 flex flex-col justify-center items-center gap-5'>
