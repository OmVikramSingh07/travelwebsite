...
function Features() {
  ...
  return (
    <div id='whyus' className='w-full lg:px-22 px-5 lg:pt-22 pt-20 pb-45 flex flex-col justify-between items-center gap-5'>
      ...
      <p data-aos="zoom-in" data-aos-delay="200" className='text-gray-500 text-center lg:w-[60%] w-full'>We don’t just plan trips — we create experiences. Our team works closely with you to understand your preferences and design a journey that matches your expectations.
      With reliable partnerships, expert guidance, and 24/7 assistance, traveling with GlobeSprint means traveling with confidence.</p>
